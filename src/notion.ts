...
import type { Task, NotionPage, NotionProperty, PropertyType } from './types/index.js';
...
export class NotionClient {
   ...
   */
  private formatTask(page: NotionPage): Task {
   ...
   * Notion 속성 값을 추출합니다
   */
  private getPropertyValue(property: NotionProperty | undefined, type: PropertyType): any {
